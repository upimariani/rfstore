			...
			<div class="col-lg-6">
				<div class="card">
					<div class="card-header">
						<h5 class="card-header-text">Perbaharui Data Diskon</h5>
						<p>Silahkan Perbaharui data diskon produk yang diperlukan.</p>
					</div>
					<form action="<?= base_url('Admin/cDiskon/update/' . $diskon->id_diskon) ?>" method="POST">
						<div class="card-block button-list">
							<div class="md-group-add-on">
								...
								<div class="md-input-wrapper">
									<select name="produk" class="md-form-control">
										...
										?>
											<option value="<?= $value->id_produk ?>" <?php if ($diskon->id_produk == $value->id_produk) {
																							echo 'selected';
							...
							<div class="md-group-add-on">
								...
								<div class="md-input-wrapper">
									<input type="text" value="<?= $diskon->nama_diskon ?>" name="nama" id="name" class="md-form-control" placeholder="Masukkan Nama Diskon" title="yourname" />
							...
							<div class="md-group-add-on">
								...
								<div class="md-input-wrapper">
									<input type="text" name="diskon" value="<?= $diskon->disc ?>" id="name" class="md-form-control" placeholder="Masukkan Besar Diskon" title="yourname" />
